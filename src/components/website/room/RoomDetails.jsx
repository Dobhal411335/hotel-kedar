                                          ...
                                          {room.amenities.map((am, i) => {
                                              ...
                                              <Tooltip key={i}>
                                                  <TooltipTrigger asChild>
                                                      <span className="bg-gray-100 px-2 py-1.5 rounded-md text-xs flex items-center justify-center cursor-default border border-border gap-1.5 transition-colors hover:text-primary">
